    ...
    <div className="space-y-6">
      ...
      {activeAITab === "analytics" && (
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[300px] w-full flex items-center justify-center text-slate-400 text-sm border border-dashed rounded-xl">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y">
                <tr>
                  <td colSpan={6} className="p-8 text-center text-slate-400">No generation history found</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      {(activeAITab === "templates" || activeAITab === "config") && (
        <div className="flex flex-col items-center justify-center h-64 text-center p-8 bg-white rounded-xl border border-dashed">
          ...
          <h3 className="font-semibold text-slate-900">AI Module Coming Soon</h3>
